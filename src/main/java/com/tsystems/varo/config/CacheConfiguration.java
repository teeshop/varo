package com.tsystems.varo.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.tsystems.varo.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.tsystems.varo.repository.UserRepository.USERS_BY_EMAIL_CACHE);
