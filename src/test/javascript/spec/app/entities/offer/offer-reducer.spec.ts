...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes([REQUEST(ACTION_TYPES.FETCH_OFFER_LIST), REQUEST(ACTION_TYPES.FETCH_OFFER)], {}, state => {
        expect(state).toMatchObject({
          errorMessage: null,
          updateSuccess: false,
          loading: true
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [REQUEST(ACTION_TYPES.CREATE_OFFER), REQUEST(ACTION_TYPES.UPDATE_OFFER), REQUEST(ACTION_TYPES.DELETE_OFFER)],
        {},
        state => {
          expect(state).toMatchObject({
            errorMessage: null,
  ...
  describe('Failures', () => {
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          FAILURE(ACTION_TYPES.FETCH_OFFER_LIST),
          FAILURE(ACTION_TYPES.FETCH_OFFER),
          FAILURE(ACTION_TYPES.CREATE_OFFER),
          FAILURE(ACTION_TYPES.UPDATE_OFFER),
          FAILURE(ACTION_TYPES.DELETE_OFFER)
        ],
        'error message',
        state => {
          expect(state).toMatchObject({
  ...
  describe('Successes', () => {
    ...
    it('should fetch a single entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_OFFER),
          payload
        })
      ).toEqual({
        ...initialState,
    ...
    it('should delete entity', () => {
      ...
      const toTest = reducer(undefined, {
        type: SUCCESS(ACTION_TYPES.DELETE_OFFER),
        payload
      });
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_OFFER_LIST actions', async () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_OFFER actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_OFFER)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_OFFER),
          payload: resolvedObject
    ...
    it('dispatches ACTION_TYPES.DELETE_OFFER actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.DELETE_OFFER)
        },
        {
          type: SUCCESS(ACTION_TYPES.DELETE_OFFER),
          payload: resolvedObject
